...
class UpdateMediaInventoryPriceRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'retail_percentage' => ['sometimes', 'required', 'numeric', 'min:0', 'max:1000'],
            'b2c_percentage' => ['sometimes', 'required', 'numeric', 'min:0', 'max:1000'],
            'b2b_percentage' => ['sometimes', 'required', 'numeric', 'min:0', 'max:1000'],
